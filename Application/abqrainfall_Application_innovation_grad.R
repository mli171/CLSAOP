...
# c2          0.8179     0.0456  17.9205  0.0000  0.7284  0.9073
# Intercept  -0.8316     0.0634 -13.1245  0.0000 -0.9558 -0.7074
# alpha      -0.2816     0.1190  -2.3659  0.0180 -0.5150 -0.0483
# B          -0.1819     0.0449  -4.0472  0.0001 -0.2700 -0.0938
# D          -0.1628     0.0481  -3.3853  0.0007 -0.2571 -0.0685
# E           0.0857     0.0477   1.7962  0.0725 -0.0078  0.1791
# F           0.1838     0.0478   3.8488  0.0001  0.0902  0.2774
# rho         0.4035     0.0292  13.8401  0.0000  0.3463  0.4606

fit2 <- fit_CLSInnov(X_hour=X_hour, X_hour_wide=X_hour_wide, DesignXEst=DesignXEst2)
round(fit2, 4)
#           Estimate Std. Error  z.value p.value   ci.lb   ci.ub
# c2          0.8228     0.0460  17.8865  0.0000  0.7326  0.9129
# Intercept  -0.7514     0.0693 -10.8408  0.0000 -0.8872 -0.6155
# alpha      -0.6840     0.2016  -3.3925  0.0007 -1.0791 -0.2888
# B          -0.1869     0.0453  -4.1254  0.0000 -0.2757 -0.0981
# D          -0.1574     0.0480  -3.2766  0.0011 -0.2516 -0.0633
# E           0.0801     0.0475   1.6849  0.0920 -0.0131  0.1733
# F           0.1753     0.0481   3.6423  0.0003  0.0810  0.2696
# Delta       0.2900     0.1233   2.3523  0.0187  0.0484  0.5317
# rho         0.3940     0.0291  13.5493  0.0000  0.3370  0.4510
